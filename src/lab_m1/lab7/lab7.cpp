...
void Lab7::Update(float deltaTimeSeconds)
{
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.50, 0.13, 0.98));
    }
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.66, 0.66, 0.66));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 &modelMatrix, const glm::vec3 &color)
{
    ...
    // Set light colour uniform
    GLint loc_light_color = glGetUniformLocation(shader->program, "light_color");
    glUniform3fv(loc_light_color, 1, glm::value_ptr(glm::vec3(1, 1, 1)));
