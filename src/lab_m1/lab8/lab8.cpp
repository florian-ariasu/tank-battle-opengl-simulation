...
void Lab8::Update(float deltaTimeSeconds)
{
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.8f, 0.60f, 0.60f));
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.5f, 0.5f, 0.0f));
    ...
    // Render the point light in the scene
    {
        ...
        modelMatrix1 = glm::translate(modelMatrix1, lightPosition2);
        modelMatrix1 = glm::scale(modelMatrix1, glm::vec3(0.1f));
        RenderSimpleMesh(meshes["box"], shaders["Simple"], modelMatrix1, glm::vec3(1.0f, 0.0f, 0.0f));
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        if (window->KeyHold(GLFW_KEY_Y)) lightPosition2 += up * deltaTime * speed;
        if (window->KeyHold(GLFW_KEY_X)) lightPosition2 -= up * deltaTime * speed;
