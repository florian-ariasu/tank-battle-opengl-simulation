...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.5, 1, 0), glm::vec3(1, 0.6, 0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1.5, 0, 1), glm::vec3(1, 0.6, 0)),
            VertexFormat(glm::vec3(0.5, 0, 0.866), glm::vec3(1, 0.2, 0.3), glm::vec3(1, 0.6, 0)),
            VertexFormat(glm::vec3(0.5, 0.866, 0.288), glm::vec3(0.5, 0.3, 0.4), glm::vec3(1, 0.6, 0)),
        };
        ...
        meshes["tetrahedron"]->InitFromData(vertices, indices);
...

    {
        vector<VertexFormat> vertices
        {
			VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(-1, 0, -1), glm::vec3(1, 1, 1), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(1, 0, -1), glm::vec3(1, 1, 1), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 1)),
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 1, 0), glm::vec3(0, 1, 1)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	//RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0, 0.5f, 0), glm::vec3(0.5f));
    // RenderMesh(meshes["cube_B"], shaders["VertexNormal"], glm::vec3(0, 0.5f, 0), glm::vec3(0.5f));

    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(0.75f));

	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 0.5f, 1.5f), glm::vec3(0.75f));
